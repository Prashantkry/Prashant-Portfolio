      ...
      <main>
        ...
        <div className="bg-gray-50 dark:bg-dark h-[85vh] p-10 -z-50">
          <div className="flex lg:flex-row justify-center items-center h-full mx-4">
            {/* info data start */}
            <div className="max-w-[50vw] h-[76vh] rounded-md 2xl:w-3/5 text-gray-900 dark:text-gray-200 border-2 border-gray-800 border-dotted p-4 m-4">
              <h1 className="text-3xl lg:text-5xl font-bold w-11/12">
                Get in touch
              </h1>
              <div className="mt-3 lg:mt-4 text-base leading-1 text-gray-900 dark:text-gray-200 md:w-8/12 2xl:w-7/12">
                <div>
            ...
            <div className="lg:w-[50vw] h-[76vh] rounded flex w-full bg-gray-100 dark:bg-black flex-col justify-center px-5 py-7 md:px-7 md:py-7 lg:py-12 lg:px-20 mt-2 md:mt-6 lg:mt-0">
