  ...
  return (
    <footer className='w-full border-t-2 border-solid border-dark font-medium
        ...
        <Layout className='py-6 flex items-center justify-between lg:flex-col lg:py-6'>
            {/* get year and copyright */}
            <span>{new Date().getFullYear()} &copy; All Right Reserved </span>
            <div className='flex items-center lg:py-2'>
                Build With <span className='text-primary dark:text-primaryDark text-2xl px-1'>&#9825;</span> by &nbsp;<Link href="/" className='underline underline-offset-2'>Prashant</Link>
            </div>
